...
This means, from now on, TensorFlow code can be used and debugged as ordinary python code (using python numpy for example). This is one aspect of making TensorFlow more pythonic.
